...
public class Security {
	...
	public String invokeHiddenMethod(){
		int dexlength = 612;
		byte[]dexFile = new byte[dexlength];
		AssetManager assetManager = this.context.getAssets();
		try {
			InputStream localInputStream = assetManager.open("Test.modified.dex");
			dexlength = localInputStream.read(dexFile, 0, dexlength);
